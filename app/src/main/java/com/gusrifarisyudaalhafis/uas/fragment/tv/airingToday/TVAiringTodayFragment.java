package com.gusrifarisyudaalhafis.uas.fragment.tv.airingToday;
...
public class TVAiringTodayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_tv_airing_today, container, false);
        ...
        //set kategori TV
        mainViewModel.setTv("airing_today");
